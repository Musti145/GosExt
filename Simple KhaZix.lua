...
Config.Key:MenuElement({id = "LastHit", name = "Last Hit with spells", key = string.byte("X")})
...
function LastHit()
        if Config.Key.Lasthit:Value() then  
...
PrintChat("Simple Series - KhaZix loaded!.")
PrintChat("Credits to Zypppy and Shulepin.")
PrintChat("Version 1.0.")
